...
df_dow.plot(ax=axes[1], x='Date', y='Open').set_xlabel('')
df_dow.plot(ax=axes[1], x='Date', y='Adj Close', color='r').set_xlabel('')
dfvix.plot(ax=axes[2], x='Date', y='VIX Close').set_xlabel('')
df_fir.plot(ax=axes[3], x='Date', y='1 Mo').set_xlabel('')
df_fir.plot(ax=axes[3], x='Date', y='3 Mo', color='black').set_xlabel('')
df_fir.plot(ax=axes[3], x='Date', y='6 Mo', color='red')
plt.show()
plt.close()
